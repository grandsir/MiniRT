...
/*   Updated: 2025/02/07 22:25:28 by muyucego         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_point_light			point_light_init(t_vector position, t_vector color,
							float power);
t_lighting				get_point_light(t_point_light light,
							t_ray_hit hittable, t_object *world);

void					check_shadow(t_object *world, t_ray light_r,
							t_lighting *l);
